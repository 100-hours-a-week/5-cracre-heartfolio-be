...
public class StockInfoPollingScheduler2 {
    ...
    @Value("${korea-invest.app-key2}")
    private String appKey;

    @Value("${korea-invest.app-secret2}")
    ...
    private void updateStockInfo(String type, String symbol) {
        try {
            ...
            System.out.println("price2 :"+redisUtil.getStockInfoTemplate(symbol).getCurPrice());
